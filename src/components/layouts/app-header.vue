<template>
 <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="/images/logo.png" class="m-r-sm">Timetable</a>
      ...
      <ul class="nav navbar-nav hidden-xs">
        ...
        <li>
          <div class="m-t m-l">
            <a href="javascript:void(0)" class="dropdown-toggle btn btn-xs btn-danger" title="Upgrade">
